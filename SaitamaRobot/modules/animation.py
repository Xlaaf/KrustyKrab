...
• `/kill`*:* Sends a kill animation. 
• `/love`*:* Sends a heart emoji animation. 
• `/hack`*:* Sends a hacking animation. 
• `/bombs`*:* Sends a bomb emoji animation. 
• `/moon`*:* Sends a moon emoji animation.
• `/clock`*:* Sends a clock emoji animation. 
• `/block`*:* Sends a blocks animation. 
• `/earth`*:* Sends an earth emoji animation.   
"""
...
__command_list__ = ["police", "love", "hack", "bombs", "moonanimation", "clockanimation", "earthanimation", "blockanimation", "kill"]
__handlers__ = [POLICE_HANDLER, LOVE_HANDLER, HACK_HANDLER, BOMBS_HANDLER, MOONANIMATION_HANDLER, CLOCKANIMATION_HANDLER, EARTHANIMATION_HANDLER, BLOCKANIMATION_HANDLER, KILL_HANDLER]
