        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "Oh, Sandy? Let's get this moving.",
                    reply_to_message_id=reply)
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text(
                    "Whoa! A member of the Staff Krusty just joined!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Sudos
                ...
                update.effective_message.reply_text(
                    "Huh! A Spongebob just joined! Stay Alert!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Support
                ...
                update.effective_message.reply_text(
                    "Huh! Someone with a Patrick level just joined!",
                    reply_to_message_id=reply,
                )
                continue
