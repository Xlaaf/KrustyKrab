...
from Spongebob import LOGGER, TIGERS, dispatcher
from Spongebob.modules.helper_funcs.chat_status import (bot_admin,
                                                           can_restrict,
                                                           connection_status,
                                                           is_user_admin,
                                                           user_admin)
...
def unmute(update: Update, context: CallbackContext) -> str:
    ...
    if member.status != 'kicked' and member.status != 'left':
        ...
        message.reply_text(
            "☺️ This user isn't even in the chat, unmuting them won't make them talk more than they "
            "already do!")
